...
{{
    ...
    "next_behaviour_type": <one of ("Manipulation", "Apology", "Answering", "Agreement", "Negotiation", "Sincere Emotions", "Conversation Stop") strictly aligned with an assistant's role description>,
