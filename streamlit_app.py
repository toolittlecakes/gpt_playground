...
Привет! Это симулятор, где ты можешь попрактиковаться в разрешении [конфликтов](https://skillslab.center/blogs/what_is_conflict) без явного риска для отношений с людьми в реальности. Все, что ты скажешь, останется здесь, и никто не узнает, что ты тут был (если ты не расскажешь 🤫).
