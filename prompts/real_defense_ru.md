...
> Право на отказ - это фраза, которая показывает Агрессору возможность выбора, например, "Если ты не готов это сделать, пожалуйста, дай мне знать" или "Я понимаю, что это может быть трудно, поэтому я пойму, если ты откажешься, но мне нужно знать твое решение"
